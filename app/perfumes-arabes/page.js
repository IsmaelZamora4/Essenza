...
export default function PerfumesArabesPage() {
  const arabes = products.filter((p) => p.category === "arabes");

  return (
    <main className="max-w-6xl mx-auto px-4 md:px-6 py-8">
      <h1 className="text-2xl md:text-3xl font-semibold text-slate-900">Perfumes Árabes</h1>
      <p className="mt-2 text-slate-600">Descubre nuestra selección de fragancias árabes.</p>
